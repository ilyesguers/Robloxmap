...
async def cmd_start(message: Message, db: Database) -> None:
    ...
    await message.answer(
        ...
        "⚙️ <b>كيف يعمل؟</b>\n"
        "• ترسل UID الحساب المستهدف فقط\n"
        "• البوت ينشئ <b>حسابات ضيف جديدة تلقائياً</b> ويرسل منها الإعجابات\n"
        "• حتى الوصول للحد اليومي (≈100 إعجاب)\n\n"
        "⚠️ الاستخدام على مسؤوليتك الخاصة (مخالف لشروط Garena).\n"
        "👇 اختر من القائمة:",
